# função def define os resultados com outras 3 ou mais variaveis, a primeira recebe o valor das restantes #

print("Bem vindo ao Teste de IMC!")

def calculadoraImc(peso, altura):
    imc = peso/(altura*altura) *10000
    if(imc <= 18.5): return "Magreza"
    elif(imc > 18.5) and (imc <= 24.9): return "Saudável"
